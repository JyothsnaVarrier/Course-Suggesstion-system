...
<html>
    ...
    <center>
        ...
        <%
            ...
            dbp.close();
            dbp.open();
            ArrayList<Group_Subject_Map> gsmList2 = dbp.selectAll_group_subject_map(gs.id,1);
            dbp.close();
        ...
        <form name="frm" action="admin_group_mark_add_action.jsp" method="post">
            <table>
                <tr>
                    <td>Student Name :</td>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td> 
                        <select name="elective_id">
                            <%
                                for(Group_Subject_Map gsm : gsmList2){
                                  dbp.open();
                                  Subject_Settings ss = dbp.select_subject_settings(gsm.subject_id);
                    ...
                    <input type="text" name="emark" value="0"> </td>
                </tr>
                <tr>
                     <td></td>
                     <td> 
